...
def print_tree(current_node, childattr='children', nameattr='name', indent='', last='updown'):
    ...
    for child in up:
        ...
        next_indent = '{0}{1}{2}'.format(indent, ' ' if 'up' in last else '│', ' ' * (len(name(current_node)) - 9))
    ...
    for child in down:
        ...
        next_indent = '{0}{1}{2}'.format(indent, ' ' if 'down' in last else '│', ' ' * (len(name(current_node)) - 9))
        print_tree(child, childattr, nameattr, next_indent, next_last)
